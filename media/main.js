...
(function () {
	...
	function fitToView() {
		...
		const svgWidth = svg.width.baseVal.value || svg.getBoundingClientRect().width / scale;
		const svgHeight = svg.height.baseVal.value || svg.getBoundingClientRect().height / scale;
